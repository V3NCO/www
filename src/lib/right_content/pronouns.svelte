<script>
    ...
    onMount(async () => {
        const res = await fetch(
            `https://pronouns.page/api/profile/get-id/01K05FJ39YFXB2553MHSV88WAP?version=2&lprops[en]=names,links,opinions,pronouns,links,flags,words,timezone,circle`,
        );
        data = await res.json();
...
{#if data}
    <div class="pronouns-container">
        <h1
            style="font-family: 'JetBrains Mono', monospace; font-size: 32px; color: #DDD; margin-bottom: 20px;"
        >
            Pronouns.page
        </h1>
                ...
                {#if data.profiles.en.flags && data.profiles.en.flags.length > 0}
                    <div class="flags-container">
                        {#each data.profiles.en.flags as flag}
                            <img
                                src={`/images/pride-flags/${flag.toLowerCase()}.png`}
                                alt={flag}
                                title={flag}
                                class="flag"
                            />
        ...
        <div class="lists">
            <section class="cols1">
                {#if data.profiles.en.names && data.profiles.en.names.length > 0}
                    <div class="names">
                        <h1
                            style="font-family:'JetBrains Mono'; font-size:32px; color:#DDD; margin-bottom:7.5px;"
                        >
                        ...
                        {#each data.profiles.en.names as name}
                            {#if name.opinion == "yes"}
                                <p class="yes">
                                    <span class="inline-icon" title="Yes"
                                        ><Icon
                                            icon="fa-solid:heart"
                                            width="16"
                                        /></span
                            ...
                            {#if name.opinion == "meh"}
                                <p class="okay">
                                    <span class="inline-icon" title="Okay"
                                        ><Icon
                                            icon="fa6-regular:thumbs-up"
                                            width="16"
                                        /></span
                                    >{name.value}{#if name.pronunciation != null}
                                        <span class="pronounciation"
                                            >{name.pronunciation}</span
                                        >{/if}
                                </p>
                ...
                {#if data.profiles.en.pronouns && data.profiles.en.pronouns.length > 0}
                    <div class="pronouns">
                        ...
                        >
                            <span class="inline-icon"
                                ><Icon icon="fa-solid:tags" width="32" /></span
                            >Pronouns
                        </h1>
                ...
                {#if data.profiles.en.links && data.profiles.en.links.length > 0}
                    <div class="links">
                        ...
                        >
                            <span class="inline-icon"
                                ><Icon icon="fa-solid:link" width="28" /></span
                            >Links
                        </h1>
            ...
            {#if data.profiles.en.words && data.profiles.en.words.length > 0}
                ...
                >
                    <span class="inline-icon"
                        ><Icon icon="fa6-solid:scroll" width="28" /></span
                    >Words
                </h1>
                <section class="cols2">
                                ...
                                {#if word.opinion == "jokingly"}
                                    <p class="jokingly">
                                        <span
                                            ...
                                            title="Jokingly"
                                            ><Icon
                                                icon="fa6-solid:face-grin-tongue"
                                                width="16"
                                            /></span
                                        >{word.value}
                                    </p>
                                {/if}
                                {#if word.opinion == "close"}
                                    <p class="close">
                                        <span
                                            class="inline-icon"
